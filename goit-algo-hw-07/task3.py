""" Додавання функції для знаходження суми всіх значень у двійковому дереві пошуку (BST) """
...
def sum_values_in_bst(root):
    """ Пошук суми всіх значень у BST дереві
    :param root: корінь дерева 
    :return: сума всіх значень у дереві 
    """
    if root is None:
        return 0
    # Сума значення поточного вузла і суми значень у лівому і правому піддеревах
    return root.val + sum_values_in_bst(root.left) + sum_values_in_bst(root.right)

# Тестування алгоритму пошуку суми всіх значень
root_bst = None
...
sum_bst = sum_values_in_bst(root_bst)
print("Сума всіх значень у двійковому дереві пошуку:", sum_bst)
...
Сума всіх значень у двійковому дереві пошуку: 90
"""
