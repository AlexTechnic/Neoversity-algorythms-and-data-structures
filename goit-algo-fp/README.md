...
![Monte-Carlo](task7.png "Ймовірності сум")
...
- Отримані результати за методом Монте-Карло дуже близькі до теоретичних аналітичних значень, що підтверджує точність симуляції.
